...
import { ContainerQueryMixin } from '../../mixins/container-query';
    ...
    public static get styles(): CSSResultArray {
        const styles = css`
            :host {
                ...
                padding: var(--ue-container-padding-vertical, var(--spectrum-global-dimension-size-50, 4px))
                    var(--ue-container-padding-horizontal, var(--spectrum-global-dimension-size-50, 4px));
                width: 100%;
                box-shadow: 1px 1px 3px var(--spectrum-alias-dropshadow-color);
            }
            :host([desktop-s]) {
                grid-template-columns:
                    minmax(1px, var(--ue-container-grid_start, 2fr)) minmax(1px, var(--ue-container-grid_center, 3fr))
